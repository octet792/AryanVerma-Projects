...
displayList = list => {
    ...
    list.map( elem => {
        ...
        if(elem.priority== "High")tag.setAttribute("class","task3");
        if(elem.priority== "Medium")tag.setAttribute("class","task2");
        if(elem.priority== "Low")tag.setAttribute("class","task1");
